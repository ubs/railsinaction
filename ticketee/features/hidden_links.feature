Feature: Hidden Links
  ...
  Background:
    ...
    Scenario: New project link is shown to only admins
    ...
    Scenario: Edit project link is shown to only admins
      Given I am signed in as "admin@ticketee.com"
      When I follow "TextMate 2"
  ...
  Scenario: Delete project link is hidden for non-signed-in users
    ...
    Scenario: Delete project link is shown to only admins
      Given I am signed in as "admin@ticketee.com"
      When I follow "TextMate 2"
