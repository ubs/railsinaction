Feature: Editing Tickets
  ...
  Scenario: Updating a ticket with invalid description length should not be allowed
    When I fill in "Description" with "< 10xtrs!"
    And I press "Update Ticket"
    Then I should see "Ticket has not been updated."

  Scenario: Cancelling edit should be allowed in case I change my mind
    When I follow "Cancel Edit"
    Then I should see "TextMate 2" within "#ticket h2"
